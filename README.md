...
| 应用式能力测评 | `web-3d/` | Three.js 沉浸式 3D 公司官网源码，包含公司介绍、解决方案、客户场景和联系方式 |
...
Three.js 沉浸式 3D 公司官网已部署为 GitHub Pages：

```text
https://nancy050416.github.io/InsightMesh-Agent/
```

说明：该在线演示对应“应用式能力测评”，用于让评审直接浏览 3D 官网效果。Agent 后端涉及数据库、模型 API Key、Ollama embedding 服务和邮件配置，出于成本与安全考虑不直接部署公网服务，完整源码、架构和本地运行方式已在仓库中提供。
